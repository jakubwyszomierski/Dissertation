...
library(rgdal)
#modelled data
PM10 <- read.csv("PostLAEI2013_2013_PM10.csv")
PM10d <- read.csv("PostLAEI2013_2013_PM10d.csv")
PM25 <- read.csv("PostLAEI2013_2013_PM25.csv")
NOx <- read.csv("PostLAEI2013_2013_NOx.csv")
NO2 <- read.csv("PostLAEI2013_2013_NO2.csv")
...
output <- readOGR("MyShapefiles/output.shp")
...
write.csv(pollutants, file="modelled_pollutants.csv", row.names = F)