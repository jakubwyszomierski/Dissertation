...
runs <- readOGR("MyShapefiles/runs.shp")
runs <- spTransform(runs, CRS("+init=epsg:27700"))

system.time(osm_buf <- readOGR("MyShapefiles/buf.shp"))
...
rgdal::writeOGR(lowess_sp, ".", layer="MyShapefiles/output", driver = "ESRI Shapefile", morphToESRI=T)
